...
class Details extends Component {
  ...
  async componentDidMount() {
    console.log('DETAILS STYLES:', styles);
    ...
    this.Listener = interstitial.addAdEventsListener(({ type, payload }) => {
      ...
      if (type === AdEventType.LOADED) {
        ...
        console.log('firebase admob event', type);
        this._toggleVideoPlayer(this.state.path, this.state.play_details, this.state.series_id);
      } else {
            ...
            {!isConnected && (
              <View
                ...
                <Text
                  ...
                  There is a problem connecting to Jai Ho. Please Try again later.
                </Text>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={[styles.episodeImageView, { position: 'absolute' }]}>
                        ...
                        {/* <TouchableOpacity activeOpacity={0.4} onPress={() => this._back()} style={styles.closeButtonContainer}>
                                    <AntDesign name='close'style={{size: 25, color: '#ff0000'}}/>
                                    </TouchableOpacity> */}
                      </View>
                      {details.type != 2 && (
                        <TouchableOpacity activeOpacity={0.7} onPress={() => this._play(details.link, details)} style={styles.videoButtonContainer}>
