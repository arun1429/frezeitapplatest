...
class VideoPlayerViewcfdaf extends Component {
  static defaultProps = {
            ...
            <View>
              {this.state.volumePosition === 0 ? (
                <TouchableOpacity activeOpacity={0.4} onPress={() => this.onToggleMute()}>
                  <FontAwesome5 name="volume-mute" style={{fontSize: 16, color: '#fff'}} />
                </TouchableOpacity>
              ) : (
                <TouchableOpacity activeOpacity={0.4} onPress={() => this.onToggleMute()}>
                  <FontAwesome5 name="volume-up" style={{fontSize: 16, color: '#fff'}} />
                </TouchableOpacity>
              )}
            </View>
          ) : null}
